    ...
    function cartesianChart(xScale, yScale) {
        ...
        var cartesianChart = function(selection) {
            ...
            selection.each(function(data, index) {
                ...
                applyTransition(svg.select('.axes-container .x-axis'))
                    .call(xAxis);

                applyTransition(svg.select('.axes-container .y-axis'))
                    .call(yAxis);

                // render the plot area
                plotArea.xScale(xScale)
                    .yScale(yScale);
                applyTransition(plotAreaContainer)
                    .call(plotArea);
        ...
        cartesianChart.transitionDuration = function(x) {
            if (!arguments.length) {
